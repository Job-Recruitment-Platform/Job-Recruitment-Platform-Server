...
CREATE TABLE company_location (
                                  ...
                                  CONSTRAINT fk_company_location_company FOREIGN KEY (company_id)
                                      REFERENCES companies(id) ON DELETE CASCADE,
                                  CONSTRAINT fk_company_location_location FOREIGN KEY (location_id)
...
CREATE TABLE candidates (
                            ...
                            date_created TIMESTAMPTZ(3) NOT NULL DEFAULT NOW(),
                            date_updated TIMESTAMPTZ(3) NOT NULL DEFAULT NOW(),
                            CONSTRAINT fk_candidates_account FOREIGN KEY (account_id)
                                REFERENCES accounts(id) ON DELETE CASCADE,
                            CONSTRAINT fk_candidates_location FOREIGN KEY (location_id)
...
CREATE TABLE sub_families (
                              ...
                              date_created TIMESTAMPTZ(3) NOT NULL DEFAULT NOW(),
                              date_updated TIMESTAMPTZ(3) NOT NULL DEFAULT NOW(),
                              CONSTRAINT fk_sub_families_job_family FOREIGN KEY (job_family_id)
...
CREATE TABLE job_roles (
                           ...
                           date_created TIMESTAMPTZ(3) NOT NULL DEFAULT NOW(),
                           date_updated TIMESTAMPTZ(3) NOT NULL DEFAULT NOW(),
                           CONSTRAINT fk_job_roles_sub_family FOREIGN KEY (sub_family_id)
                               REFERENCES sub_families(id) ON DELETE CASCADE
);
...
CREATE TABLE candidate_skills (
                                  ...
                                  level INTEGER CHECK (level >= 0 AND level <= 5), -- 0..5
...
CREATE TABLE jobs (
                      ...
                      CONSTRAINT fk_jobs_company FOREIGN KEY (company_id)
                          REFERENCES companies(id) ON DELETE CASCADE,
                      CONSTRAINT fk_jobs_job_role FOREIGN KEY (job_role_id)
...
CREATE TABLE job_skill_requirements (
                                        ...
                                        CONSTRAINT fk_job_skill_requirements_job FOREIGN KEY (job_id)
                                            REFERENCES jobs(id) ON DELETE CASCADE,
                                        CONSTRAINT fk_job_skill_requirements_skill FOREIGN KEY (skill_id)
                                            REFERENCES skills(id) ON DELETE CASCADE
);
